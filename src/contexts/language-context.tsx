...
export const translations: Record<Lang, Translations> = {
    en: {
        ...
        portfolioProjectDescs: [
            ...
            "Product rating & review UI with intelligent filtering, animated star ratings, and multilingual support.",
            "Modern banking interface with transaction flows, card management widgets, and secure form patterns.",
            "Peer-to-peer skill exchange platform with smart profile matching, session booking, and progress tracking.",
    ...
    ru: {
        ...
        portfolioProjectDescs: [
            ...
            "Интерфейс рейтингов и отзывов с интеллектуальной фильтрацией и поддержкой нескольких языков.",
            "Современный банковский интерфейс с потоками транзакций и управлением картами.",
            "Платформа обмена навыками с подбором профилей, бронированием сессий и отслеживанием прогресса.",
    ...
    uz: {
        ...
        portfolioProjectDescs: [
            ...
            "Aqlli filtrlash, yulduzcha animatsiyalari va ko'p tilli qo'llab-quvvatlash bilan mahsulot baholash interfeysi.",
            "Tranzaksiya oqimlari, karta boshqaruvi va xavfsiz forma naqshlari bilan zamonaviy bank interfeysi.",
            "Profil moslash, seans bron qilish va rivojlanishni kuzatish bilan tengdoshlar ko'nikma almashinuvi platformasi.",
